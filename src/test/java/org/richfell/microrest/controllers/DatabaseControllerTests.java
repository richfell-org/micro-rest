...
public class DatabaseControllerTests
{
    ...
    throws Exception
    {
        ...
        sayingsList.add(new Saying(2, "Jay Unet", "Unit testing is a great mystery."));
        ...
        mockMvc
            ...
            .andExpect(jsonPath("$.[1].quote", is("Unit testing is a great mystery.")));
    }
    ...
    /**
     * Sends an empty body when creating a new saying.
     * 
     * @throws Exception 
     */
    @Test
    public void createSayingInvalidEntity()
    throws Exception
    {
        mockMvc
            .perform(
